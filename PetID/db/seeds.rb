...
appt_1 = Appointment.create(reason_for_visit: 'Dental', date_time: 0)
appt_2 = Appointment.create(reason_for_visit: 'Medical Exam', date_time: 0)
appt_3 = Appointment.create(reason_for_visit: 'Medication Refill', date_time: 0)
appt_4 = Appointment.create(reason_for_visit: 'New Patient Visit', date_time: 0)
appt_5 = Appointment.create(reason_for_visit: 'Surgery', date_time: 0)
appt_6 = Appointment.create(reason_for_visit: 'Welness Exam', date_time: 0)
appt_7 = Appointment.create(reason_for_visit: 'Vaccinations', date_time: 0)
